...
class ConcreteOrchestrator(AbstractOrchestrator):
    ...
    def __init__(self):
        ...
        Constructor
        '''               
    def generate_app_components_requests(self, components, matchmaking_model):
        ...
        for component in matchmaking_model[application_instance]:
            application_component_instance = application_instance + '-' + component['component']
            for application_component_instance_req in components:
                if application_component_instance_req.component_name == application_component_instance:
                    None
    ...
    def generate_federation_resource_availability(self,components, RID_response, matchmaking_model):
        return None
    ...
    def calculate_dep_plan(self, components, RID_response, matchmaking_model):
        ...
        """
        App_Components_req = self.generate_app_components_requests(components,matchmaking_model)
        Fed_res_availability = self.generate_federation_resource_availability(RID_response, matchmaking_model)
